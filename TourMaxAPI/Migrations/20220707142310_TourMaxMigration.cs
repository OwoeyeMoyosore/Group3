...
{
    public partial class TourMaxMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tourImages_tourCategories_TourCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TourUserId = table.Column<int>(type: "int", nullable: false),
                    TourUserId1 = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tours_AspNetUsers_TourUserId1",
                        column: x => x.TourUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tours_bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tourImages_TourCategoryId",
                table: "tourImages",
                column: "TourCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Tours_BookingId",
                table: "Tours",
                column: "BookingId");
